    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li><a href="{{ route('profile') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-user-gear"></i></span>
            ...
            @elseif(auth()->user()->app_type == 2)
                <li><a href="{{ route('appointments') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-calendar-check"></i></span>
                        <span>@lang('admin.reception.appointments_list')</span></a></li>
                <li><a href="{{route('add-patient')}}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-user-plus"></i></span>
                        <span>@lang('admin.reception.add_patient')</span></a></li>
                <li><a href="{{ route('add-appointment') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-calendar-plus"></i></span>
                        <span>@lang('admin.reception.add_appointment')</span></a></li>
                <li><a href="{{ route('chatList') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-comments"></i></span>
                        <span>@lang('admin.chat_list')</span></a></li>
            @else
                @if(in_array(auth()->user()->app_type, [1, 7,11]))
                    <li><a href="{{ route('admin.doctors.ratings') }}" class="{{ request()->routeIs('admin.doctors.ratings') ? 'active' : '' }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-star-half-stroke"></i></span>
                            <span>@lang('admin.doctors_ratings')</span></a></li>

                    <li><a href="{{ route('departments') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-layer-group"></i></span>
                            <span>@lang('admin.departments')</span></a></li>

                    <li><a href="{{ route('offers') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-tags"></i></span>
                            <span>@lang('admin.Manage Offers')</span></a></li>

                    <li><a href="{{ route('specialties') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-stethoscope"></i></span>
                            <span>@lang('admin.Manage available specialties')</span></a></li>

                    @if(auth()->user()->app_type != 7)
                        <li><a href="{{ route('branches') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-code-branch"></i></span>
                                <span>@lang('admin.Manage Branch')</span></a></li>
                    @endif

                    <li><a href="{{ route('clinic.supervisor') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-user-shield"></i></span>
                            <span>@lang('admin.SuperVisor Management')</span></a></li>

                    <li><a href="{{ route('contactUs') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-comments"></i></span>
                            <span>@lang('admin.Complaints Box')</span></a></li>

                    <li><a href="{{ route('change-password') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-key"></i></span>
                            <span>@lang('admin.Change Password')</span></a></li>

                    <li><a href="{{ route('setting','about') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-circle-info"></i></span>
                            <span>@lang('admin.About The App')</span></a></li>
                    <li><a href="{{ route('setting','privacy') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-shield-halved"></i></span>
                            <span>@lang('admin.Privacy Policy')</span></a></li>
                    <li><a href="{{ route('setting','terms') }}"><span class="menu-side clinic-admin-menu-icon"><i class="fa-solid fa-file-contract"></i></span>
                            <span>@lang('admin.Terms of use')</span></a></li>
                ...
                <li><a href="{{ route('setting','terms') }}"><span class="menu-side">
                            <img style="background-color: #888" src="/media/icons/Terms of use.png" alt=""></span>
                             <span>@lang('admin.Terms of use')</span></a></li>
                @endif
                </ul>
                <div class="logout-btn">
